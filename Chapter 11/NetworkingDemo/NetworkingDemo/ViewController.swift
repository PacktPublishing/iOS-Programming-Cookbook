...
class ViewController: UIViewController {
    ...
    func shareContact(contact: Contact){
        let contactInfo = "Name: \(contact.firstName) \(contact.lastName) \nEmail: \(contact.email)\n Cell phone: \(contact.cellPhone)"
        let photoImageURL = URL(string: contact.pictureURLString)
        
        let activityViewController = UIActivityViewController(activityItems: [contactInfo, photoImageURL], applicationActivities: nil)
